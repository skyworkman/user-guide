    ...
    return this.createUserGuide(
      [
            ...
            timer(0, 200)
              .pipe(
                filter(() => {
                  ...
                  if (item != null) {
                    item.setAttribute("data-guide", "taskbasic-organizationName-test")
                    return true
                  }
                  return false
                }),
        ...
        },
        {
          ...
          description: "任务基础信息配置<br />还可以根据需要配置任务高级选项<br/>点击展开任务高级选项",
          bindEvent: true
        },
        {
        ...
        },
        {
          ...
          description: "任务基础信息配置<br />任务基础信息配置完毕<br/>点击下一步",
          bindEvent: true
        },
        {
        ...
        {
          elementSelector: "[data-guide=datasource-db-tables] .ant-tree-checkbox",
        ...
        {
          elementSelector: "[data-guide=taskwizard-nextstep-ok] .ant-btn-primary",
        ...
        {
          elementSelector: "[data-guide=matchpolicies-dialog-next-step]:not([disabled])",
        ...
        {
          elementSelector: "[data-guide=matchpolicies-dialog-enter]:not([disabled])",
        ...
        {
          elementSelector: "[data-guide=tasklistpage-taskitem] .tasklistpage-taskitem",
          ...
          canNext: (t: HTMLElement) => {
            return interval(500).pipe(
              filter(_ => {
                ...
                return !!ele && !!ele.textContent && ele.textContent.trim() === "成功完成"
              }),
              first(),
              map(_ => true)
            )
